...
const OG_IMAGE = "https://images.visitauschwitz.info/entering-gate-arbeit-macht-frei-auschwitz-hero.webp";
...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: {
      ...
      locale,
      type: "website",
      images: [{ url: OG_IMAGE, width: 1200, height: 630, alt: "Arbeit Macht Frei gate at Auschwitz-Birkenau Memorial" }],
    },
    twitter: {
